...
class KitchenSink(BaseCase):
    ...
    def test_video(self):
        ...
        expected_media = {
            ...
            "filename": "elife-00666-media1.mp4",
            # this is a bad link in the case of the kitchen sink only, generated by expanding the uris
            "uri": "https://publishing-cdn.elifesciences.org/00666/elife-00666-media1.mp4",
